...
import { getDisplayTitle, getDisplayDescription, getDisplayMaterials, getDisplayColor } from "@/lib/productDisplay";
...
export default async function ProductPage({
  ...
  const color = getDisplayColor(product, locale);
          ...
          <div className="flex flex-col gap-12 md:flex-row">
            ...
            <div className="flex w-full flex-col text-right md:w-1/2">
              ...
              <p className="mb-6 text-3xl font-bold text-yellow-600">
                {formatPrice(product.price_value, locale)}
              </p>
